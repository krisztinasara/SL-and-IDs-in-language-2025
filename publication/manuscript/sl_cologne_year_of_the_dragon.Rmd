...
|-----------|-----------|-----------|-----------|-----------|-----------|-----------|
| COG   | PROC_SPEED               | vis_RT_med          | split-half\*     | 0.957             | n.a.              | yes      |
| COG   | PROC_SPEED               | ac_RT_med           | split-half\*     | 0.956             | n.a.              | yes      |
| COG   | PROC_SPEED               | vis_dec_score       | split-half\*     | 0.179             | n.a.              | no       |
| COG   | PROC_SPEED               | vis_dec_RT_med      | split-half\*     | 0.952             | n.a.              | yes      |
| COG   | simon                    | RT_score            | split-half\*     | 0.643             | n.a.              | yes      |
| COG   | simon                    | ACC_score           | split-half\*     | 0.546             | n.a.              | yes      |
| COG   | stroop                   | RT_score            | split-half\*     | 0.768             | n.a.              | yes      |
| COG   | stroop                   | ACC_score           | split-half\*     | 0.876             | n.a.              | yes      |
| COG   | DigitSpan                | forward_span        | n.a.             | n.a.              | n.a.              | yes      |
| COG   | DigitSpan                | backward_span       | n.a.             | n.a.              | n.a.              | yes      |
| COG   | n_back                   | nback_1_dprime      | split-half\*     | 0.807             | n.a.              | yes      |
| COG   | n_back                   | nback_2_dprime      | split-half\*     | 0.763             | n.a.              | yes      |
| COG   | n_back                   | nback_3_dprime      | split-half\*     | 0.691             | n.a.              | yes      |
| SL    | SEGM_AL_adult_300ms_2key | median RT training  | split-half\*     | 0.646             | n.a.              | yes      |
| SL    | SEGM_AL_adult_300ms_2key | median RT TRN-RND   | split-half\*     | 0.768             | n.a.              | yes      |
| SL    | SEGM_AL_adult_300ms_2key | median RT RND-REC   | split-half\*     | 0.778             | n.a.              | yes      |
| SL    | SEGM_AL_adult_300ms_2key | ACC training        | split-half\*     | 0.855             | n.a.              | yes      |
| SL    | SEGM_AL_adult_300ms_2key | ACC TRN-RND         | split-half\*     | 0.850             | n.a.              | yes      |
| SL    | SEGM_AL_adult_300ms_2key | ACC RND-REC         | split-half\*     | 0.761             | n.a.              | yes      |
| SL    | SEGM_AL_adult_300ms_2key | 2AFC bigram         | n.a.             | n.a.              | n.a.              | yes      |
| SL    | SEGM_AL_adult_300ms_2key | 2AFC trigram        | n.a.             | n.a.              | n.a.              | yes      |
| SL    | SEGM_AL_adult_300ms_2key | production          | n.a.             | n.a.              | n.a.              | yes      |
| SL    | AGL_KS_mod4              | median RT training  | split-half\*     | 0.222             | n.a.              | no       |
| SL    | AGL_KS_mod4              | median RT TRN-RND   | split-half\*     | 0.270             | n.a.              | no       |
| SL    | AGL_KS_mod4              | median RT RND-REC   | split-half\*     | 0.247             | n.a.              | no       |
| SL    | AGL_KS_mod4              | ACC training        | split-half\*     | 0.634             | n.a.              | yes      |
| SL    | AGL_KS_mod4              | ACC TRN-RND         | split-half\*     | 0.380             | n.a.              | no       |
| SL    | AGL_KS_mod4              | ACC RND-REC         | split-half\*     | 0.390             | n.a.              | no       |
| SL    | AGL_KS_mod4              | 2AFC sentence       | n.a.             | n.a.              | n.a.              | yes      |
| SL    | AGL_KS_mod4              | 2AFC bigram-trigram | n.a.             | n.a.              | n.a.              | yes      |
| SL    | AGL_KS_mod4              | production          | n.a.             | n.a.              | n.a.              | yes      |
| LANG  | predictive               | RT_score            | split-half\*     | 0.853             | n.a.              | yes      |
| LANG  | predictive               | ACC_score           | split-half\*     | 0.585             | n.a.              | yes      |
| LANG  | trog                     | gramm               | omega            | 0.672             | 1                 | no       |
| LANG  | trog                     | pragm               | omega            | 0.630             | 1                 | yes      |
| LANG  | MENYET                   |                     | omega            | 0.676             | 1                 | yes      |
| LANG  | selfpaced                | GP_target           | omega            | 0.506             | 1                 | yes      |
| LANG  | selfpaced                | GP_plus1            | omega            | -0.060            | 0                 | no       |
| LANG  | selfpaced                | mnGP_target         | omega            | 0.270             | 0                 | no       |
| LANG  | selfpaced                | mnGP_plus1          | omega            | 0.140             | 0                 | no       |
| LANG  | selfpaced                | mellekmondat_target | omega            | -0.030            | 1                 | no       |
| LANG  | selfpaced                | mellekmondat_plus1  | omega            | 0.576             | 0                 | no       |
| LANG  | selfpaced                | sertes_target       | omega            | 0.681             | 1                 | yes      |
| LANG  | selfpaced                | sertes_plus1        | omega            | 0.391             | 0                 | no       |
| LANG  | OMR                      | read_syls           | n.a.             | n.a.              | n.a.              | yes      |
...
During these steps, seven indices were removed from the initial 32 indices for not meeting the KMO test criterion, and two additional indices were dropped due to model refinement. Thus, the final dataset included 23 indices from 12 different tasks (Table XXY).
...
Indices with unsatisfactory fit for EFA (MSA \< 0.5) were excluded: \* SEGM_AL_ACC_train \* SEGM_AL_ACC_TRN3_RND4 \* SEGM_AL_ACC_RND4_REC5 \* AGL_ACC_train Then, KMO test was repeated.
...
In one case (*SEGM_AL_2AFC_bigram*), the unexplained variance was high (\>0.65), however we kept it to assign convergent reliability to the SL_trigram variable. We further excluded the *SEGM_AL_midRT_train* variable to solve the Heywood case present in this factor.
...
Indices with unsatisfactory fit for EFA (MSA \< 0.6) were excluded: \* simon_ACC_score \* stroop_ACC_score Then, KMO test was repeated.
...
Based on the two models, we concluded that *model_PS_02* indicates a better model considering four fit indices (TLI, CFI, SRMR, RMSEA) and the BIC. So for further analyses, we used the *PROC_SPEED_vis_dec_RT_med* index as a single-variable latent factor retaining the other two variables as the *PS factor*.
...
We excluded the *predictive_ACC_score* index which showed unacceptable KMO values (\< 0.5).
...
All indices are now in the acceptable range (\> 0.6), and the *predictive_RT_score* is also near the boundary.
...
| model           | CFI  | R-CFI | TLI  | R-TLI | RMSEA | SRMR |
|-----------------|------|-------|------|-------|-------|------|
...
| SL overall      | .986 | .983  | .971 | .966  | .027  | .032 |

*Note.* CFI: = Comparative Fit Index, R-CFI: = Robust Comparative Fit Index, TLI: = Tucker-Lewis Index, R-TLI: = Robust Tucker-Lewis Index, RMSEA: = Root Mean Square Error of Approximation, SRMR: = Standardised Root Mean Square Residual.
