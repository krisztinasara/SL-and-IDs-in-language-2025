# -*- coding: utf-8 -*-
"""
Created on Thu Mar  9 12:19:53 2023
...
DF = pd.read_csv("C:/Users/Kriszti/LENDULET/kiserletek/elemzesek/AN_stroop/data/stroop_long_20230307.csv")
...
for i in range(0, 100):
    ...
    for t in [(RTs, 'RTs'), (ACCs, 'ACCs')]:
        r = t[0]['score_x'].corr(t[0]['score_y'], method = 'pearson')
        rs[t[1]].append((2 * r) / (1 + r))

results = pd.DataFrame({'RTs' : rs['RTs'],
                        'ACCs' : rs['ACCs']})
results.to_csv("C:/Users/Kriszti/GitHub/lendulet_language_SL/task_data/stroop/data/stroop_reliability_split_half_iterations.csv",
               index = False)
