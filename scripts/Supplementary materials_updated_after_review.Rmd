...
iterations, Spearman-Brown corrected at each iteration. Regarding the unidimensionality tests, numeral 1 signals that an index passed the test and numeral 0 signals that an index failed the test.
...
| LANG   | garden path sentence processing   | violation processing    |
| LANG   | sentence violation processing     | violation processing    |
| LANG   | predictive sentence processing RT | semantic prediction     |
| LANG   | one minute reading                | reading fluency         |
...
# 5. Latent factor identification without predefined domains

## 5.1. Summary for the process of latent factor identification
...
## 5.2. Latent factors without domain specification
...
# 6. Exploraing developmental effects
...
#### 6.2.1.2. Estimating model fits for different age groups
...
#### 6.2.1.3. Invariance tests for different age groups
...
#### 6.2.2.2. Estimating model fits for different age groups
...
#### 6.2.2.3. Invariance tests for different age groups
...
#### 6.2.3.2. Estimating model fits for different age groups
...
#### 6.2.3.3. Invariance tests for different age groups
...
#### 6.2.4.2. Estimating model fits for different age groups
...
#### 6.2.4.3. Invariance tests for different age groups
...
#### 6.2.5.2. Estimating model fits for different age groups
...
#### 6.2.5.3. Invariance tests for different age groups
