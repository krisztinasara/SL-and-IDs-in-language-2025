...
RT~incongruent~ - median RT~congruent~) indices. Larger differences
between incongruent and congruent trials were assumed to be associated
with lower inhibitory control efficiency. To align scoring with this
...
(median RT~incongruent~ - median RT~congruent~). We hypothesized that
