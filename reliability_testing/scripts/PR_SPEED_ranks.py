# -*- coding: utf-8 -*-
"""
Created on Tue Mar 28 10:07:27 2023
...
for i in range(0, iternum):
    ...
    for index in ['ac_dec_RT_med', 'ac_dec_score']:
        r = all_data[index + '_one'].corr(all_data[index + '_two'], method = 'spearman')
        rs[index].append((2 * r) / (1 + r))
...
results.to_excel(
    "C:/Users/Kriszti/GitHub/lendulet_language_SL/reliability_testing/results/processing_speed_ranks.xlsx"
    )
