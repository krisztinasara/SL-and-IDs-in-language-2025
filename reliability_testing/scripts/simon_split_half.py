# -*- coding: utf-8 -*-
"""
Created on Thu Mar  9 17:54:01 2023
...
results = pd.DataFrame({'RTs' : rs['RTs'],
                        'ACCs' : rs['ACCs']})
results.to_csv("C:/Users/Kriszti/GitHub/lendulet_language_SL/task_data/simon/data/simon_reliability_split_half_iterations.csv",
               index = False)
