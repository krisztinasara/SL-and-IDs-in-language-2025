...
colnames(pred) = c(
  "SEGM RT", "SEGM 2AFC", "SEGM prod", "AGL",
  "PS", "digit span", "nback", "stroop", "simon", "PS vis dec",
  "gramm sens", "reading", "pred", "OMR", "pragm"
  )
rownames(pred) = c(
  "SEGM RT", "SEGM 2AFC", "SEGM prod", "AGL",
  "PS", "digit span", "nback", "stroop", "simon", "PS vis dec",
...
```{r}
# SL language
mat_SL_lang = pred[c(1, 2, 3, 4, 11, 12, 13, 14, 15), c(1, 2, 3, 4, 11, 12, 13, 14, 15)]
