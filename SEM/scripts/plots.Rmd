...
SEGM_RT =~ 1*SEGM_AL_medRT_TRN3_RND4 + 1*SEGM_AL_medRT_RND4_REC5
...
colnames(pred) = c(
  ...
  "processing speed", "digit span", "nback", "Stroop", "Simon", "visual decision speed",
  "grammatical sensitivity", "self-paced reading", "predictive sentence processing", "one minute reading", "pragmatic understanding"
  )
rownames(pred) = c(
  "SEGM RT", "SEGM 2AFC", "SEGM production", "AGL", "AGL phrase",
  "processing speed", "digit span", "nback", "Stroop", "Simon", "visual decision speed",
  "grammatical sensitivity", "self-paced reading", "predictive sentence processing", "one minute reading", "pragmatic comprehension"
  )
```
